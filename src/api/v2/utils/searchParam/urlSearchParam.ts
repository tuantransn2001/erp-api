...
export class URLSearchParam {
  ...
  public static objToUrlParams(obj: ObjectType<any>) {
    const toUrlParams = (obj: ObjectType<any>, prefix = "") => {
      // create url params
      let urlParams = "";
  ...
  public static urlParamsToObj(urlParams: string) {
    ...
    const toObj = (urlParams: string) => {
      ...
      const subUrlParamsObj: ObjectType<any> = {};
  ...
  public static checkIfObjShouldBeArrayAndConvert(obj: ObjectType<any>) {
    // if obj is an array
  ...
  public static addObjToUrl(obj: ObjectType<any>, url = window.location.href) {
