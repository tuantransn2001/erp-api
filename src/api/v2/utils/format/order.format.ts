...
interface CustSuppQueryAttributes extends CustSuppAttributes {
  User: {
...
interface OrderItemQueryAttributes extends OrderAttributes {
  ...
  CustSupp: { dataValues: CustSuppQueryAttributes };
...
export const handleFormatOrder = (
  ...
  if (formatType === "isObject") {
    ...
    const { id: custSupp_id } = OrderSource.dataValues.CustSupp.dataValues;
    const {
      id: user_id,
      user_name: supplier_name,
      user_phone: supplier_phone,
    } = OrderSource.dataValues.CustSupp.dataValues.User.dataValues;

    const supplier_address_list =
      OrderSource.dataValues.CustSupp.dataValues.User.dataValues.UserAddresses;
  ...
  return OrderSource.map((orderItem: OrderSourceAttributes) => {
    ...
    const {
      ...
      user_name: supplier_name,
      user_phone: supplier_phone,
    } = orderItem.dataValues.CustSupp.dataValues.User.dataValues;
    const { user_name: staff_name } =
