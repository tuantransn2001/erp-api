...
<<<<<<<< HEAD:build/production/v1/models/Order.ts
import { OrderAttributes } from "@/src/api/v1/ts/interfaces/app_interfaces";
========
import { OrderAttributes } from "@/src/api/v2/ts/interfaces/app_interfaces";
>>>>>>>> dev/api-v2:src/api/v2/models/Order.ts
